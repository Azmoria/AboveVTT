		...
		if(token.isMonster()){
			...
			if(window.DM){
				...
				$(ct_show_checkbox).change(function() {
					if($(this).is(':checked')) {
						token.options.ct_show = true;
						$("#"+token.options.id+"hideCombatTrackerInput ~ button .openEye").css('display', 'block');
						$("#"+token.options.id+"hideCombatTrackerInput ~ button .closedEye").css('display', 'none');
					}
					else{
						token.options.ct_show = false;
						$("#"+token.options.id+"hideCombatTrackerInput ~ button .closedEye").css('display', 'block');
						$("#"+token.options.id+"hideCombatTrackerInput ~ button .openEye").css('display', 'none');
					}
