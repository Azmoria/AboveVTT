...
class Token {
	...
	build_elev() {
		...
		let elevation = !isNaN(parseFloat(this.options.elev)) ? parseFloat(this.options.elev) : 0;
		
		if(this.options.includeMapElev == true && !isNaN(parseFloat(this.options.mapElev))){
			elevation += parseFloat(this.options.mapElev)
		}
		...
		if (elevation != 0) {
			...
			<text x='6px' y='8px' style="font-weight: bold;font-size: 5px;stroke: #000;stroke-width: 8%;paint-order: stroke;stroke-linejoin: round;fill: #fff;text-anchor: middle;">${elevation}</text>
